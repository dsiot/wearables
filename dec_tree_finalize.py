...
if __name__=='__main__':
    ...
    for n_iter in tqdm(range(total_iter)):
        ...
        conf_matrix_list_train.append(confmatrix_dtree(clf,x_train,y_train,n_roc,pos_label=0))
        conf_matrix_list_test.append(confmatrix_dtree(clf,x_test,y_test,n_roc,pos_label=0))
